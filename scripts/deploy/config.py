...
MAX_CPU_LORA = 6
SERVE_PORT = 5000
FORWARD_TIMEOUT_S = float(os.getenv("MEMLORA_FORWARD_TIMEOUT_S", "2"))
FORWARD_RETRY_TIMEOUT_S = float(os.getenv("MEMLORA_FORWARD_RETRY_TIMEOUT_S", "1.5"))
FORWARD_MAX_ATTEMPTS = max(1, int(os.getenv("MEMLORA_FORWARD_MAX_ATTEMPTS", "2")))
